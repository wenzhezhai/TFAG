...
# Sample images
parser.add_argument('--shape', type=bool, default=True)
...
parser.add_argument('--latent_space_type', default='w_plus', choices=['w', 'w_plus', 'w_plus_text'], type=str)
parser.add_argument('--regularize_vl', default=0.1, type=float, help='Weight of the vision-language alignment loss item')
...
if args.mode == 'manip':
    ...
    --regularize_vl={args.regularize_vl}
    """
    print(f"{command} \n")
    os.system(command)
    os.chdir('..')
